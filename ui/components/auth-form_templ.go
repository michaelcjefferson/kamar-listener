...
func AuthForm(newUser bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if newUser {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "<label for=\"confirm-password\">Confirm Password:</label> <input type=\"password\" id=\"confirm-password\" name=\"confirm-password\" required><br><button type=\"submit\">Register</button>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		} else {
